...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final GeoLibraryAccessors laccForGeoLibraryAccessors = new GeoLibraryAccessors(owner);
    ...
    private final KtxLibraryAccessors laccForKtxLibraryAccessors = new KtxLibraryAccessors(owner);
    ...
    /**
     * Returns the group of libraries at geo
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public GeoLibraryAccessors getGeo() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForGeoLibraryAccessors;
    }
    ...
    /**
     * Returns the group of libraries at ktx
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public KtxLibraryAccessors getKtx() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForKtxLibraryAccessors;
    }

    /**
     * Returns the group of libraries at media
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
     ...
     */
    @Deprecated
    public static class GeoLibraryAccessors extends SubDependencyFactory {

        public GeoLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for compose (dev.icerock.moko:geo-compose)
             * This dependency was declared in catalog libs.versions.toml
         * @deprecated Will be removed in Gradle 9.0.
             */
        @Deprecated
     ...
     */
    @Deprecated
    public static class KtxLibraryAccessors extends SubDependencyFactory {

        public KtxLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
    ...
    public static class MediaLibraryAccessors extends SubDependencyFactory {
        ...
        public MediaLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for filePicker (com.darkrockstudios:mpfilepicker)
             * This dependency was declared in catalog libs.versions.toml
         * @deprecated Will be removed in Gradle 9.0.
             */
        @Deprecated
            ...
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
                return create("media.filePicker");
        }
    ...
    public static class MokoLibraryAccessors extends SubDependencyFactory {
        private final MokoMediaLibraryAccessors laccForMokoMediaLibraryAccessors = new MokoMediaLibraryAccessors(owner);
        private final MokoPermissionsLibraryAccessors laccForMokoPermissionsLibraryAccessors = new MokoPermissionsLibraryAccessors(owner);

        public MokoLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at moko.media
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public MokoMediaLibraryAccessors getMedia() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForMokoMediaLibraryAccessors;
        }

        /**
         * Returns the group of libraries at moko.permissions
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public MokoPermissionsLibraryAccessors getPermissions() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForMokoPermissionsLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class MokoMediaLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public MokoMediaLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for media (dev.icerock.moko:media)
             * This dependency was declared in catalog libs.versions.toml
         * @deprecated Will be removed in Gradle 9.0.
             */
        @Deprecated
            public Provider<MinimalExternalModuleDependency> asProvider() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
                return create("moko.media");
        }

            /**
             * Creates a dependency provider for compose (dev.icerock.moko:media-compose)
             * This dependency was declared in catalog libs.versions.toml
         * @deprecated Will be removed in Gradle 9.0.
             */
        @Deprecated
            public Provider<MinimalExternalModuleDependency> getCompose() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
                return create("moko.media.compose");
        }
     ...
     */
    @Deprecated
    public static class MokoPermissionsLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public MokoPermissionsLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        @Deprecated
            public Provider<MinimalExternalModuleDependency> asProvider() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
                return create("moko.permissions");
        }
        ...
        @Deprecated
            public Provider<MinimalExternalModuleDependency> getCompose() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
                return create("moko.permissions.compose");
        }
    ...
    public static class SqldelightLibraryAccessors extends SubDependencyFactory {
        ...
        public SqldelightLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for androidDriver (app.cash.sqldelight:android-driver)
             * This dependency was declared in catalog libs.versions.toml
         * @deprecated Will be removed in Gradle 9.0.
             */
        @Deprecated
        ...
        @Deprecated
            ...
            /**
             * Creates a dependency provider for nativeDriver (app.cash.sqldelight:native-driver)
             * This dependency was declared in catalog libs.versions.toml
         * @deprecated Will be removed in Gradle 9.0.
             */
        @Deprecated
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final KamelVersionAccessors vaccForKamelVersionAccessors = new KamelVersionAccessors(providers, config);
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: geoCompose (0.6.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getGeoCompose() { return getVersion("geoCompose"); }
            ...
            /**
             * Returns the version associated to this alias: ktor (2.3.10)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: ktxDateTime (0.4.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getKtxDateTime() { return getVersion("ktxDateTime"); }
            ...
            /**
             * Returns the version associated to this alias: mediaFilePicker (3.1.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getMediaFilePicker() { return getVersion("mediaFilePicker"); }

            /**
             * Returns the version associated to this alias: mokoMedia (0.11.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getMokoMedia() { return getVersion("mokoMedia"); }
        ...
        /**
         * Returns the group of versions at versions.kamel
         */
        public KamelVersionAccessors getKamel() {
            return vaccForKamelVersionAccessors;
        }
    ...
    public static class ComposeVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Returns the version associated to this alias: compose (1.6.6)
         * If the version is a rich version and that its not expressible as a
         * single version string, then an empty string is returned.
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> asProvider() { return getVersion("compose"); }
            ...
            /**
             * Returns the version associated to this alias: compose.plugin (1.6.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class KamelVersionAccessors extends VersionFactory  {

        public KamelVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: kamel.image (0.9.3)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getImage() { return getVersion("kamel.image"); }
    ...
    public static class KoinVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        public Provider<String> asProvider() { return getVersion("koin"); }
            ...
            /**
             * Returns the version associated to this alias: koin.compose (1.0.4)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
